...
![Architecture](architecture/high-level-diagram.svg)
...
### Abandoned Cart
![Abandoned Cart](architecture/data-flow-abandoned-cart.svg)

### Order Cancelled
![Order Cancelled](architecture/data-flow-order-cancelled.svg)
